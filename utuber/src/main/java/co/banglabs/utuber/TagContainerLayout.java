...
import static co.banglabs.utuber.Utils.dp2px;
import static co.banglabs.utuber.Utils.sp2px;
...
public class TagContainerLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray attributes = context.obtainStyledAttributes(attrs, co.banglabs.utuber.R.styleable.AndroidTagView,
                defStyleAttr, 0);
        mVerticalInterval = (int) attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_vertical_interval,
                dp2px(context, DEFAULT_INTERVAL));
        mHorizontalInterval = (int) attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_horizontal_interval,
                dp2px(context, DEFAULT_INTERVAL));
        mBorderWidth = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_container_border_width,
                dp2px(context, mBorderWidth));
        mBorderRadius = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_container_border_radius,
                dp2px(context, mBorderRadius));
        mTagBdDistance = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_tag_bd_distance,
                dp2px(context, mTagBdDistance));
        mBorderColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_container_border_color,
                mBorderColor);
        mBackgroundColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_container_background_color,
                mBackgroundColor);
        mDragEnable = attributes.getBoolean(co.banglabs.utuber.R.styleable.AndroidTagView_container_enable_drag, false);
        mSensitivity = attributes.getFloat(co.banglabs.utuber.R.styleable.AndroidTagView_container_drag_sensitivity,
                mSensitivity);
        mGravity = attributes.getInt(co.banglabs.utuber.R.styleable.AndroidTagView_container_gravity, mGravity);
        mMaxLines = attributes.getInt(co.banglabs.utuber.R.styleable.AndroidTagView_container_max_lines, mMaxLines);
        mTagMaxLength = attributes.getInt(co.banglabs.utuber.R.styleable.AndroidTagView_tag_max_length, mTagMaxLength);
        mTheme = attributes.getInt(co.banglabs.utuber.R.styleable.AndroidTagView_tag_theme, mTheme);
        mTagBorderWidth = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_tag_border_width,
                dp2px(context, mTagBorderWidth));
        mTagBorderRadius = attributes.getDimension(
                co.banglabs.utuber.R.styleable.AndroidTagView_tag_corner_radius, dp2px(context, mTagBorderRadius));
        mTagHorizontalPadding = (int) attributes.getDimension(
                co.banglabs.utuber.R.styleable.AndroidTagView_tag_horizontal_padding,
                dp2px(context, mTagHorizontalPadding));
        mTagVerticalPadding = (int) attributes.getDimension(
                co.banglabs.utuber.R.styleable.AndroidTagView_tag_vertical_padding, dp2px(context, mTagVerticalPadding));
        mTagTextSize = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_tag_text_size,
                sp2px(context, mTagTextSize));
        mTagBorderColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_tag_border_color,
                mTagBorderColor);
        mTagBackgroundColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_tag_background_color,
                mTagBackgroundColor);
        mTagTextColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_tag_text_color, mTagTextColor);
        mTagTextDirection = attributes.getInt(co.banglabs.utuber.R.styleable.AndroidTagView_tag_text_direction, mTagTextDirection);
        isTagViewClickable = attributes.getBoolean(co.banglabs.utuber.R.styleable.AndroidTagView_tag_clickable, false);
        isTagViewSelectable = attributes.getBoolean(co.banglabs.utuber.R.styleable.AndroidTagView_tag_selectable, false);
        mRippleColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_tag_ripple_color, Color.parseColor("#EEEEEE"));
        mRippleAlpha = attributes.getInteger(co.banglabs.utuber.R.styleable.AndroidTagView_tag_ripple_alpha, mRippleAlpha);
        mRippleDuration = attributes.getInteger(co.banglabs.utuber.R.styleable.AndroidTagView_tag_ripple_duration, mRippleDuration);
        mEnableCross = attributes.getBoolean(co.banglabs.utuber.R.styleable.AndroidTagView_tag_enable_cross, mEnableCross);
        mCrossAreaWidth = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_tag_cross_width,
                dp2px(context, mCrossAreaWidth));
        mCrossAreaPadding = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_tag_cross_area_padding,
                dp2px(context, mCrossAreaPadding));
        mCrossColor = attributes.getColor(co.banglabs.utuber.R.styleable.AndroidTagView_tag_cross_color, mCrossColor);
        mCrossLineWidth = attributes.getDimension(co.banglabs.utuber.R.styleable.AndroidTagView_tag_cross_line_width,
                dp2px(context, mCrossLineWidth));
        mTagSupportLettersRTL = attributes.getBoolean(co.banglabs.utuber.R.styleable.AndroidTagView_tag_support_letters_rlt,
                mTagSupportLettersRTL);
        mTagBackgroundResource = attributes.getResourceId(co.banglabs.utuber.R.styleable.AndroidTagView_tag_background,
